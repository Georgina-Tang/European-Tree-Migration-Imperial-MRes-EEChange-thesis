...
# hist(tps_special_epd_12_elv$Fagus_mean)
# hist(special_epd_1_3$Fagus_mean)
#0~0.5
...
library(ggplot2)
ggsave(file="Fagus 1-1.2ka Special EPD Map.jpeg",p1,width=22,height=11)
...
ggsave(file="Fagus 2-2.2ka Special EPD Map.jpeg",p2,width=22,height=11)
...
ggsave(file="Fagus 3-3.2ka Special EPD Map.jpeg",p3,width=22,height=11)
...
ggsave(file="Fagus 4-4.2ka Special EPD Map.jpeg",p4,width=22,height=11)
...
ggsave(file="Fagus 5-5.2ka Special EPD Map.jpeg",p5,width=22,height=11)
...
ggsave(file="Fagus 6-6.2ka Special EPD Map.jpeg",p6,width=22,height=11)
...
ggsave(file="Fagus 7-7.2ka Special EPD Map.jpeg",p7,width=22,height=11)
...
ggsave(file="Fagus 8-8.2ka Special EPD Map.jpeg",p8,width=22,height=11)
...
ggsave(file="Fagus 9-9.2ka Special EPD Map.jpeg",p9,width=22,height=11)
...
ggsave(file="Fagus 10-10.2ka Special EPD Map.jpeg",p10,width=22,height=11)
...
ggsave(file="Fagus 11-11.2ka Special EPD Map.jpeg",p11,width=22,height=11)
...
p12<-p12 +
  ...
  scale_color_manual(     values = c( "absence"="#9E9E9E" ,  "0.04"="#3B9AB2" , "0.05"="#53A5B9", 
                                      ...
                                      "0.1"="#E6C019", "0.2"="#E3B408",
                                      "0.3"="#E49100" ,"0.4"="#EB5500","0.5+"="#F21A00"))
ggsave(file="Fagus 11.8-12.0 ka Special EPD Map.jpeg",p12,width=22,height=11)
