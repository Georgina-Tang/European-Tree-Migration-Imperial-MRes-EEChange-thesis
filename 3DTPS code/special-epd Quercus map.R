#special-epd Quercus.deciduous map
...
setwd("C:/Users/X1 Carbon/OneDrive - Imperial College London/Tree Migration- Colin/Output data/after new data 05-04/special epd/TPS paleo calculation Quercus")
...
# hist(tps_special_epd_12_elv$Quercus.deciduous_mean)
# hist(special_epd_1_3$Quercus.deciduous_mean)
#0~3??
...
p1<-tps_special_epd_1_elv %>%
  dplyr::mutate(
    Quercus.deciduous_mean = Quercus.deciduous_mean %>%
      cut(
  ...
  smpds::plot_climate_tiles(var = "Quercus.deciduous_mean",
                            fill_scale =
...
library(ggplot2)
ggsave(file="Quercus.deciduous 1-1.2ka Special EPD Map.jpeg",p,width=22,height=11)
...
ggsave(file="Quercus.deciduous 2-2.2ka Special EPD Map.jpeg",p,width=22,height=11)
...
ggsave(file="Quercus.deciduous 3-3.2ka Special EPD Map.jpeg",p,width=22,height=11)
...
ggsave(file="Quercus.deciduous 4-4.2ka Special EPD Map.jpeg",p,width=22,height=11)
...
ggsave(file="Quercus.deciduous 5-5.2ka Special EPD Map.jpeg",p,width=22,height=11)
...
ggsave(file="Quercus.deciduous 6-6.2ka Special EPD Map.jpeg",p,width=22,height=11)
...
ggsave(file="Quercus.deciduous 7-7.2ka Special EPD Map.jpeg",p,width=22,height=11)
...
ggsave(file="Quercus.deciduous 8-8.2ka Special EPD Map.jpeg",p,width=22,height=11)
...
ggsave(file="Quercus.deciduous 9-9.2ka Special EPD Map.jpeg",p,width=22,height=11)
...
ggsave(file="Quercus.deciduous 10-10.2ka Special EPD Map.jpeg",p,width=22,height=11)
...
ggsave(file="Quercus.deciduous 11-11.2ka Special EPD Map.jpeg",p,width=22,height=11)
...
ggsave(file="Quercus.deciduous 11.8-12.0 ka Special EPD Map.jpeg",p,width=22,height=11)
